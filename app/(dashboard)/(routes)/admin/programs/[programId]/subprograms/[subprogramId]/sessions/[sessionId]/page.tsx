...
import { ArrowLeft, File, LayoutDashboard, ListTodo } from 'lucide-react';
...
const Page = async ({
  params: { programId, subprogramId, sessionId },
}: {
  params: {
    programId: string;
    subprogramId: string;
    ...
    <div className='p-6'>
      <div className='flex items-center justify-between'>
        <div className='w-full'>
          <Link
            href={`/admin/programs/${programId}/subprograms/${subprogramId}`}
          ...
          <div className='flex items-center justify-between w-full'>
            <div className='flex flex-col gap-y-2'>
              <h1 className='text-2xl font-medium'>Create Session</h1>
